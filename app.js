                        ...
                        pg.connect(DATABASE_URL, function(err, client, done) {
                            client.query(query, function(err, result) {
                                ...
                                if (err) {
                                    ...
                                    summary += `@[${sender}] enviou ${sender_thanks_sent}`;
                                    ...
                                    recipients.forEach(function(recipient) {
                                        ...
                                        if(managers[recipient]) {
                                            summary += ` e @[${recipient}] recebeu ${recipient_thanks_received} agradecimentos na última semana. :O Olha só, @[${managers[recipient]}]! :D\n`;
                                        } else {
                                        	summary += ` e @[${recipient}] recebeu ${recipient_thanks_received} agradecimentos na última semana. :O Infelizmente não sei quem é o seu líder :(\n`;
                                        }
                                    });
